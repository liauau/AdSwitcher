...
from switcher.models.constant import EXPIRES_INTERVAL_TIME, FB_ENABLE, JH_ENABLE, AD_ENABLE, PLACEMENT, CONTEXT, SID, \
    ...
    OUTER_ENABLED, CLICK_STRATEGY, COOL_DOWN, GRAY_PLATFORM
...
class CrackNodeSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = CrackNode
        fields = (
            PKG_NAME, GRAY_PLATFORM, AD_ENABLE, FB_ENABLE, JH_ENABLE, OUTER_ENABLED, CLICK_STRATEGY, INTERSTITIAL_INTERNAL,
    ...
    def update_node(self, node, node_data):
        ...
        node.gp = node_data.get(GRAY_PLATFORM, node.gp)
        node.save()
