...
from switcher.models.constant import EXPIRES_INTERVAL_TIME, FB_ENABLE, JH_ENABLE, AD_ENABLE, PLACEMENT, CONTEXT, SID, \
    PKG_NAME, EXTRA, START_TIMES, MAX_TIMES, VERSION_NAME, VERSION_CODE, LABEL, SIGNATURES
...
class CrackNodeSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = CrackNode
        fields = (PKG_NAME, AD_ENABLE, FB_ENABLE, JH_ENABLE, EXPIRES_INTERVAL_TIME, PLACEMENT, CONTEXT)
